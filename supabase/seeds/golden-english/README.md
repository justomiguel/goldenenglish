...
Datos de ejemplo para el tenant **Golden English** del repo: tokens en `properties` alineados con [`SYSTEM_PROPERTIES_DEFAULTS`](../../../src/lib/theme/systemPropertiesDefaults.ts) (identidad, paleta, sombras, layout, contacto y redes).
