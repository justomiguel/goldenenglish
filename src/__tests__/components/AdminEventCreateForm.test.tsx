...
const labels = {
  ...
  currencyGatewayWarning: "Unsupported currency for online payment.",
  bankTransferInstructionsLabel: "Bank transfer details",
  bankTransferInstructionsHint: "Shown before uploading receipts.",
  submit: "Create event",
  back: "Back to events",
