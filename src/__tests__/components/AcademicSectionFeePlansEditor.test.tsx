...
const dict = {
  ...
  paymentsCount: "Payments per period",
  paymentsShort: "payments",
  chargesEnrollmentFee: "Charges enrollment fee",
  matriculaYes: "with matricula",
  matriculaNo: "no matricula",
  periodStartMonth: "Period start month",
  periodStartYear: "Period start year",
  periodStartShort: "starts",
  inUseBadge: "In use",
