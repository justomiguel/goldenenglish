/** Brand social glyphs — Lucide removed Facebook/Instagram; use these SVGs instead. */

export function BrandFacebookIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function BrandInstagramIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
