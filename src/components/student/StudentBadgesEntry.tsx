...
/**
 * Tier A: achievements list matches desktop vs mobile/PWA shell of other student areas.
 */
export function StudentBadgesEntry({ children }: { children: ReactNode }) {
  return (
    <SurfaceMountGate
      skeleton={<BadgesSkeleton />}
