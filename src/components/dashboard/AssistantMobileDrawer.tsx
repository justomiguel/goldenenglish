...
export interface AssistantMobileDrawerProps {
  locale: string;
  dict: Dictionary;
}

export function AssistantMobileDrawer({ locale, dict }: AssistantMobileDrawerProps) {
  const navDict = dict.dashboard.assistantNav;
  const chromeDict = dict.dashboard.assistantChrome;
