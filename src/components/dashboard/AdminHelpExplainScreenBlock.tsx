...
export type AdminHelpExplainScreenDict = Dictionary["dashboard"]["adminHelpExplainScreen"];

export interface AdminHelpExplainScreenBlockProps {
  dict: AdminHelpExplainScreenDict;
  /** Localized screen title when a tour exists. */
  screenTitle: string | null;
  /** Localized one-line blurb when a tour exists. */
...
/**
 * Contextual “Explain this screen” CTA — always first in the help panel.
 */
export function AdminHelpExplainScreenBlock({
  dict,
  screenTitle,
  screenDescription,
  available,
  busy = false,
  onStart,
}: AdminHelpExplainScreenBlockProps) {
  return (
    <section
