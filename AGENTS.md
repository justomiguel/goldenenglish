...
| **`39-commit-product-changelog.mdc`** | Antes de cada commit con cambio visible, agregar la entrada en `src/lib/product-changelog/catalog.ts` (Novedades del sistema). |
